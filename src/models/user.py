...
class User:
    def __init__(self, email, password, _id=None):  # create User object with specified email, password and id is
    ...
    @classmethod
    def register(cls, email, password):  # if user does not already exist, User object is created and saved to database
